  ...
  return (
    <section id="home" className="not-margin">
      ...
      <div className="description" data-aos="fade-up">
        ...
        <p>
          The Legendary Krocs are the 36 Krocs that look after the other Krocs. Once all Kruisy Krocs 
          are sold out each owner of these Legendary Kroc NFTs will stand the chance to walk away with 
          a $20,000 bonus. The Stonk Kroc will walk away with a bonus of $30,000.
        </p>
      </div>
