...
const RoadMAP = () => {
    const dataArray = [
        ...
        {title: "PHASE - 2", bodyText: <p>Amidst the Ethereum blockchain jungle. You have come to an undiscovered swamp, filled with 5,000 Kruisy Krocs vibing away. There will be 36 Legendary Krocs, holders of Legendary Krocs will unlock benefits that are out of this world. As our community grows, so will the benefits. <br />Minting begins.</p>},
        {title: "PHASE - 3", bodyText: <p>Once all 5,000 Krocs have been minted, the reveal will happen 48 hours after. Followed by the creation of a DAO. We will set aside 10% of mint sales and 50% of secondary sales royalty into the DAO wallet. This will be secured via multiple signature wallets.</p>},
