...
import { Menu, Close, ChevronRight, ChevronLeft, Instagram } from '@material-ui/icons';
            ...
            <header className="web-header">
                <div className="cs_row header-container">
                    <div className="header-logo-area cs_row">
                        <a onClick={()=> scrollTo_Section('home')} href="javascript:void(0)" className="cs_row">
                            <img className="header-main-logo" loading="lazy" src={logo} alt="KRUICY KROCS" />
                        </a>
                        <img className="krocs-logo" loading="lazy" src={logo1} alt="KROCS" />
                    </div>
                    <div className="header-right-area">
                        <a href="https://discord.gg/kruisykrocs" target="_blank" className="header-join-btn cs_row">
                ...
                <nav className={`side-bar-wrapper ${sideBar ? 'opened-sidebar' : ''}`}>
                    ...
                    <ul>
                        <li><a onClick={() => { setSideBar(false); scrollTo_Section('home'); }} href="javascript:void(0)">Home</a></li>
                        <li><a onClick={() => { setSideBar(false); scrollTo_Section('roadmap') }} href="javascript:void(0)">RoadMap</a></li>
                        <li><a onClick={() => { setSideBar(false); scrollTo_Section('devroadmap') }} href="javascript:void(0)">Development RoadMap</a></li>
                        <li><a onClick={() => { setSideBar(false); scrollTo_Section('faq') }} href="javascript:void(0)">FAQ</a></li>
                        <li><a onClick={() => { setSideBar(false); scrollTo_Section('team') }} href="javascript:void(0)">Team</a></li>
                    </ul>
